...
import ucr.cs.Chattanooga.Chattanooga;
...
public class Violent {
	...
	public  static void isViolent (Chattanooga ch) throws Exception
	{
		boolean csv;
	     ...
	     //   System.out.println(s1);
          ...
          if(csv){
	        	...
	        	s3 = row3[0].toLowerCase().toLowerCase().trim();
